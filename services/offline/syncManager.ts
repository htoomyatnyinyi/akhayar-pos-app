...
// // ============================================
// // PULL: Server မှ Data ယူပြီး Local DB သိမ်းခြင်း
// // ============================================

// async function pullProducts() {
//   const { data: remoteProducts } = await store.dispatch(
//     remoteApi.endpoints.getRemoteProducts.initiate(undefined, {
//       forceRefetch: true,
//     }),
//   );
...
//       await db
//         .insert(products)
//         .values({ ...product, syncStatus: "synced" })
//         .onConflictDoUpdate({
//           target: products.id,
//           set: {
//             ...product,
...
//         });
//     }
//     store.dispatch(localApi.util.invalidateTags(["LocalProducts"]));
//   }
// }

// // ============================================
// // PUSH: Local DB မှ Pending Items များကို Server သို့ ပို့ခြင်း
// // ============================================
...
//       // Update local order with remote ID
//       await db
//         .update(orders)
//         .set({ remoteId: data.id, syncStatus: "synced" })
//         .where(eq(orders.id, item.entityId));
...
//       console.log(`✅ Order ${item.entityId} pushed successfully`);
//     } catch (error) {
//       await db
//         .update(syncOutbox)
//         .set({
...
//     // 1. PULL: Products, Categories, Customers, Stores, Sessions
//     await pullProducts();
...
//     // 2. PUSH: Orders, Inventory Movements, etc.
//     await pushOrders();
//     // await pushInventoryMovements();

//     // 3. Invalidate all local tags to refresh UI
//     store.dispatch(
//       localApi.util.invalidateTags([
//         "LocalProducts",
//         "LocalCategories",
