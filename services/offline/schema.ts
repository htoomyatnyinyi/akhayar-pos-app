...
export type LocalStaff = typeof staff.$inferSelect; // ✅ NEW
export type LocalSupplier = typeof suppliers.$inferSelect; // ✅ NEW
...
export type InsertStaff = typeof staff.$inferInsert; // ✅ NEW
export type InsertSupplier = typeof suppliers.$inferInsert; // ✅ NEW
...
// //   dateOfBirth: text("date_of_birth"),
// //   gender: text("gender"),
// //   debtAmount: real("debt_amount").notNull().default(0), // 🌟 Added to match API
// //   loyaltyPoints: integer("loyalty_points").notNull().default(0),
// //   totalSpent: real("total_spent").notNull().default(0),
// //   totalOrders: integer("total_orders").notNull().default(0),
// //   tier: text("tier").notNull().default("BRONZE"),
