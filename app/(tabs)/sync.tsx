// ============================================
// FILE: app/(main)/sync/index.tsx (Cleaned)
// ============================================
...
import { getSyncQueueSummary } from "@/services/offline/repository";
  ...
  return (
    <Screen padded={false}>
      ...
      >
        ...
        <View className="mt-2">
          <TouchableOpacity
            className="bg-rose-500/10 rounded-xl p-4 border border-rose-500/20 mb-3"
          ...
          >
            ...
            <Text className="text-slate-400 text-xs mt-1">
              Remove all offline data (products, orders, pending sync)
            </Text>
          </TouchableOpacity>

          <TouchableOpacity
            className="bg-rose-500/10 rounded-xl p-4 border border-rose-500/20"
          ...
          >
            ...
            <Text className="text-slate-400 text-xs mt-1">
              Clear data and return to login
            </Text>
          </TouchableOpacity>
        </View>
      </ScrollView>
