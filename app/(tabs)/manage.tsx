...
// // Category Selector Component - Updated to use ScrollView instead of FlatList
// function CategorySelector({
//   value,
//   onChange,
//   categories,
...
//                 onChangeText={(v) => {
//                   set("role", v);
//                   if (v && ["ADMIN", "MANAGER", "CASHIER"].includes(v)) {
//                     set("permissions", getDefaultPermissions(v));
//                   }
//                 }}
//               />
...
//               <Field
//                 label="Stock Qty"
//                 value={fields.stockQuantity?.toString() ?? ""}
//                 onChangeText={(v) => {
//                   const num = parseInt(v, 10);
//                   set("stockQuantity", isNaN(num) ? 0 : num);
//                 }}
//               />
...
// //       else if (moduleKey === "stores") await deleteStore(item.id).unwrap();
// //       else if (moduleKey === "categories")
// //         // else if (moduleKey === "categories" && user?.storeId)
// //         await deleteCategory(item.id).unwrap();
// //       else if (moduleKey === "suppliers")
// //         await deleteSupplier(item.id).unwrap();
// //       else if (moduleKey === "customers")
...
// // //               <Field
// // //                 label="Selling Price"
// // //                 value={String(fields.sellingPrice ?? "")}
// // //                 onChangeText={(v) => set("sellingPrice", Number(v || 0))}
// // //               />
// // //               <Field
// // //                 label="Cost Price"
// // //                 value={String(fields.costPrice ?? "")}
// // //                 onChangeText={(v) => set("costPrice", Number(v || 0))}
// // //               />
// // //               <Field
// // //                 label="Stock Qty"
// // //                 value={String(fields.stockQuantity ?? "")}
// // //                 onChangeText={(v) => set("stockQuantity", Number(v || 0))}
// // //               />
// // //               <Field
// // //                 label="Category Name"
// // //                 value={fields.categoryName ?? ""}
