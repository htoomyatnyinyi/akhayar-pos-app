    ...
    <Screen>
      <SafeAreaView className="flex-1">
        ...
        >
          ...
          {/* Summary Cards with current store badge */}
...
function getModuleList(input: any) {
  ...
  // Return all sessions sorted by openedAt descending
...
// ============================================
// EDITOR MODAL (Enhanced with loading states)
// ============================================
...
//   // Replace single session query with list + orders
...
//   // Get list for current module (sessions now returns all)
//   const list = getModuleList({
//     moduleKey,
//     staff,
//     products: productsWithVariants,
...
//         notes: notes.trim() || undefined,
//         storeId: currentStoreId || undefined,
//         registerId: "default-register", // hardcoded for now
//       }).unwrap();
//       await refetchSessions();
//       await refetchOrders();
//       Alert.alert("Success", "Session opened successfully");
...
//           <Card>
//             {moduleKey === "sessions" ? (
//               // Session-specific list with cards
//               sessions.length ? (
//                 sessions.map((session: any) => {
//                   const isActive = session.status === "OPEN";
//                   const sessionOrders = orders.filter(
...
//                 </Text>
//               )
//             ) : // Existing list for other modules
//             list.length ? (
//               list.map((item: any, index: number) => (
//                 <View
//                   key={item.id ? `item-${item.id}` : `idx-${index}`}
...
//   if (moduleKey === "suppliers") return suppliers;
//   if (moduleKey === "brands") return brands;
//   // Return all sessions sorted by openedAt descending (most recent first)
//   return [...sessions].sort(
//     (a, b) => new Date(b.openedAt).getTime() - new Date(a.openedAt).getTime(),
//   );
// }
...
//   const sessionToClose = activeSession; // we always close the active session
...
// //       onRequestClose={onClose}
// //     >
// //       {/* FIX: Wrapper View with dark background fills the entire modal */}
// //       <View className="flex-1 bg-slate-950">
// //         <SafeAreaView className="flex-1 px-4 pt-4">
// //           <Header
// //             eyebrow="Editor"
...
// // // ============================================
// // // SESSION MODAL (FIXED BACKGROUND)
// // // ============================================
...
// //       {/* FIX: Wrapper View with dark background */}
// //       <View className="flex-1 bg-slate-950">
// //         <SafeAreaView className="flex-1 px-4 pt-4">
// //           <Header
// //             eyebrow="Session"
...
// //             keyboardType="decimal-pad"
// //             placeholder={
// //               mode === "open" ? "Opening balance" : "Closing balance"
// //             }
// //             placeholderTextColor="#64748b"
